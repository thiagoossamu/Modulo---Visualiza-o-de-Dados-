...
DATA_PATH = os.path.join('data', 'ecommerce_estatistica.csv') if os.path.exists(os.path.join('data', 'ecommerce_estatistica.csv')) else 'ecommerce_estatistica.csv'
...
def cria_app(dataframe):
    ...
    def visibilidade_e_carga_estatica(selected_values):
        ...
        fig6 = px.violin(dataframe, x='Preço', color='Temporada', orientation='h', points=False, title='Densidade de Preço por Temporada')
